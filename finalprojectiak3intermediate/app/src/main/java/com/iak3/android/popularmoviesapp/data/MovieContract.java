...
public class MovieContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.iak3.android.popularmoviesapp";
    public static final Uri BASE_CONTENT_URI = parse("content://" + CONTENT_AUTHORITY);
